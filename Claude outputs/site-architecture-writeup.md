...
This site is a static React application, but "static" undersells what's actually happening behind it. There are two distinct flows worth separating: what happens when I push a change, and what happens when someone visits the site. The diagram splits along exactly that line.
